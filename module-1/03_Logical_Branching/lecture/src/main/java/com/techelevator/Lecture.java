...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenGreaterThanFiveInOneLine(int number) { return number > 5; }
    ...
    */
        public String returnFizzIfThreeUsingTernary(int number) { return (number ==3)? "Fizz" : ""; }
        (return)
    /*
